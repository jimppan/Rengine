#ifndef RENGINE_INPUT_H
#define RENGINE_INPUT_H
...
namespace Rengine
{
	...
	public:
		...
		inline static Vector2f GetMousePosition() { return s_Instance->GetMousePositionImpl(); }
	protected:
		virtual bool IsKeyDownImpl(KeyCode keycode) = 0;
		virtual bool IsMouseButtonDownImpl(MouseButton button) = 0;
		virtual Vector2f GetMousePositionImpl() = 0;
	private:
